...
Owns the users, roles, permissions, memberships and access policies business capability.
...
- Identity-specific domain concepts.
...
The Identity project is scaffolded for Sprint 0 and will be populated according to the sprint plan.
