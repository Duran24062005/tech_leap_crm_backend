...
Contains the business entities, value objects, invariants and domain policies for the Work module.

## Responsibilities

Implements only concerns owned by Work and keeps dependencies flowing inward toward the domain.
...
This is an intentional Sprint 0 scaffold and will be populated with Work functionality in its corresponding sprint.
