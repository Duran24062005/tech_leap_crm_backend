...
Owns the private documents, versions and access policies business capability.
...
- Documents-specific domain concepts.
...
The Documents project is scaffolded for Sprint 0 and will be populated according to the sprint plan.
