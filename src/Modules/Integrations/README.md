...
Owns the external connections, webhooks, cursors and mappings business capability.
...
- Integrations-specific domain concepts.
...
The Integrations project is scaffolded for Sprint 0 and will be populated according to the sprint plan.
